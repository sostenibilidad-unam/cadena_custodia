...
for folio in range(126, 309):
   
    if folio < 10:
        folioString = "LANCIS-PCR-FCC-F000" + str(folio)
    elif folio < 100:
        folioString = "LANCIS-PCR-FCC-F00" + str(folio)
    else:
        folioString = "LANCIS-PCR-FCC-F0" + str(folio)
        
#     if folio < 26:
#         colector = "Jesús Sotomayor Bonilla" 
#     elif folio < 51:
#         colector = "Omar García Suárez"  
#     elif folio < 76:
#         colector = "Shiara González Padrón"  
#     elif folio < 101:
#         colector = "Andrés López Pérez" 
#     else:
#         colector = "Julio Barrón Rodríguez"    
    ...
    pluma.write(r'    \hline' + '\n')
    pluma.write(r'    Folio : {\color{red}' + folioString + r'/2015} & Fecha : 3/07/2015 & Observaciones \\    \hline' + '\n')
    ...
    pluma.write(r'    \hline' + '\n')
    pluma.write(r'    Gerardo Suzán Azpiri & ' + colector + r'\\     \hline' + '\n')
    pluma.write(r'    \end{tabular}' + '\n') 
    ...
    pluma.write(r'    \begin{tabular}{|>{\centering\arraybackslash}p{0.7cm}|>{\centering\arraybackslash}p{1.7cm}|>{\centering\arraybackslash}p{1.4cm}|>{\centering\arraybackslash}p{1.4cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{0.6cm}|>{\centering\arraybackslash}p{1.6cm}|>{\centering\arraybackslash}p{3.3cm}|>{\centering\arraybackslash}p{2.3cm}|}' + '\n')
    pluma.write(r'    \hline' + '\n')
    ...
    pluma.write(r'    \hline ' + '\n') 
    pluma.write(r'     &   &  &   & \vspace{0mm}Si & \vspace{0mm}No &   &   & \\[5ex]' + '\n')    
    pluma.write(r'    \hline ' + '\n')
    pluma.write(r'     &   &  &   & \vspace{0mm}Si & \vspace{0mm}No &   &   & \\[5ex]' + '\n')     
    pluma.write(r'    \hline' + '\n') 
    pluma.write(r'     &   &  &   & \vspace{0mm}Si & \vspace{0mm}No &   &   & \\[5ex]' + '\n')    
    ...
    pluma.write(r'    Tipos de muestra: S=Sangre; O=Orina; PP=Pelo/Pluma; UG=Uñas/garra; PI=Piel; Ce=Cerebro; C=Corazón; H=Higado; B=Bazo; R=Riñon; Hu=Hueso; MP=Metales pesados(Al, As, Cd, Cu, Fe, Mn, Hg, Ni, Pb, Zn)\\' + '\n')
    
    pluma.write(r'Continúa en el anverso de esta hoja Registro de Cadena Custodia\vspace{5mm}' + '\n')
